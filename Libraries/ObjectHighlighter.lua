-- I got this xray/esp module from https://github.com/benbrimeyer/rbx-ObjectHighlighter
-- I just converted all the modulescripts into this 1 lua file
...
-- CreateBasePartCopy
function createBasePartCopy(basePart)
...
-- createInstanceCopy
function createInstanceCopy(instance)
...
-- Implementations
local DEFAULT_IMPLEMENTATION = {}
function DEFAULT_IMPLEMENTATION.worldColor()
    return function()
        local connections = {}
...
function DEFAULT_IMPLEMENTATION.highlightColor()
    return {
        onBeforeRender = function(_, _)
            return true
        end,
...
return {
    createFromTarget = function(targetModel)
        Highlight.fromTarget(targetModel)
    end,

    createRenderer = function(screenGui)
        Renderer.new(screenGui)
    end,

    Implementations = DEFAULT_IMPLEMENTATION
}
